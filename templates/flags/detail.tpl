    ...
    <div class="media">
      ...
      <div class="media-body">
        <h4 class="media-heading">
          <a href="{config.relative_path}/user/{target.user.userslug}">{target.user.username}</a></h4>
        {target.content}
      </div>
    </div>
          ...
          <div class="media">
            ...
            <div class="media-body">
              ...
              <ul>
                <!-- BEGIN fields -->
                <li>
                  <span class="label label-primary">@key</span><!-- IF @value --> &rarr;
                  <span class="label label-default">@value</span><!-- ENDIF @value -->
                </li>
                <!-- END fields -->
              </ul>
            </div>
