  ...
  <div class="row">
      ...
      <div class="well">
        ...
        <div class="checkbox">
          <label>
            ...
            <strong>[[user:delay_image_loading]]</strong>
          </label>
        </div>
      ...
      <div class="well">
        ...
        <div class="checkbox">
          <label>
            ...
            <strong>[[user:send_chat_notifications]]</strong>
          </label>
        </div>
        ...
        <div class="checkbox">
          <label>
            ...
            <strong>[[user:send_post_notifications]]</strong>
          </label>
        </div>
      </div>
    ...
    <div class="col-xs-12 col-md-6">
      ...
      <div class="well">
        ...
        <strong>[[user:topics_per_page]] ([[user:max_items_per_page, {maxTopicsPerPage}]])</strong><br/>
        <input type="text" class="form-control" data-property="topicsPerPage" value="{settings.topicsPerPage}"><br/>
        <strong>[[user:posts_per_page]] ([[user:max_items_per_page, {maxPostsPerPage}]])</strong><br/>
        <input type="text" class="form-control" data-property="postsPerPage" value="{settings.postsPerPage}"><br/>
      </div>
      ...
      <div class="well">
        ...
        <div class="row">
          ...
          <div class="btn-group col-xs-3">
            <button type="button" class="form-control btn btn-sm btn-default" data-action="play">
              <span class="hidden-xs">[[global:play]] </span><i class="fa fa-play"></i></button>
          </div>
        </div>
